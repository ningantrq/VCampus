...
public class stuOrderMenuController {
    @FXML
    ...
    public void initialize() throws IOException {
        ...
        // 加载数据到 TableView
        OrderPojo[] temp = OrderSend.getStuOrderData(TempUser.getTUser().getUId());
    ...
    private void search () throws IOException {
        ...
        if (!keyword.isEmpty()) {
            ...
            OrderPojo[] allOrder = OrderSend.getStuOrderData(TempUser.getTUser().getUId());
...
//        }
    ...
    public void displayAllOrder(MouseEvent mouseEvent) throws IOException {
        OrderPojo[] gList = OrderSend.getStuOrderData(TempUser.getTUser().getUId());
        orderList.clear();
